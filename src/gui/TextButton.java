...
public class TextButton extends HighlightableButton{
    ...
    public TextButton(Vector2f position, String text, Vector3f backgroundColor, Vector3f highlightColor, Vector3f textColor, FontType font, float fontSize, float width, float edge){
        super();
        this.text = new GUIText(text, fontSize, font, new Vector2f(position.x + GeneralSettings.TEXT_BUTTON_PADDING, position.y+fontSize*0.06f + GeneralSettings.TEXT_BUTTON_PADDING), width, edge, textColor, new Vector4f(-2, -2, -2, -2), true, false);
    ...
    public TextButton(String text){
        super();
        this.text = new GUIText(text, GeneralSettings.FONT_SIZE, GeneralSettings.TACOMA, new Vector2f(0,0), GeneralSettings.FONT_WIDTH, GeneralSettings.FONT_EDGE, GeneralSettings.TEXT_COLOR, new Vector4f(-2, -2, -2, -2), true, false);
