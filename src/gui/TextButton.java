...
public class TextButton extends HighlightableButton{
    ...
    public TextButton(String text){
        super();
        this.text = new GUIText(text, GeneralSettings.FONT_SIZE, GeneralSettings.TACOMA, new Vector2f(0,0), GeneralSettings.FONT_WIDTH, GeneralSettings.FONT_EDGE, GeneralSettings.TEXT_COLOR, new Vector4f(-2, -2, -2, -2), true);
